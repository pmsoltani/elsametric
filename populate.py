...
#         'country': d2._read(
#             'country',
#             search={'name': {'value': country(source['Country']), 'operator': '='}}
#         )[-1][0],
#     }
#     print(cnt)
#     print(source_info)
...
# table_name = 'subject'
# search = {
#     'type': {'value': 'ar', 'operator': '='},
#     'source_id': {'value': 1234, 'operator': '='}
# }
# data = [
#     {
#         'asjc_code': 9999,
...
#     }
# ]
# server_response = d2._insert_many(table_name=table_name, data=data)
# print(server_response)
